...
from rl_attack.experiments.p4_v2e_preparation import (  # noqa: E402
    prepare_p4_v2e,
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Prepare or verify P4-v2e signed-return critic")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    if args.command == "prepare":
        result = prepare_p4_v2e(args.config, output_directory=args.output_dir)
    else:
        result = verify_p4_v2e_preparation(
            args.config,
            args.preparation,
            expected_manifest_sha256=args.expected_manifest_sha256,
            replay_collection=not args.no_replay,
        )
