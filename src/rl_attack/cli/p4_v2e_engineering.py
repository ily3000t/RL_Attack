...
from rl_attack.experiments.p4_v2e_engineering import (  # noqa: E402
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run or verify P4-v2e engineering screen")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    if args.command == "run":
        result = run_p4_v2e_engineering(args.config, args.output_dir)
    else:
        result = verify_p4_v2e_engineering(
            args.config,
            args.run,
